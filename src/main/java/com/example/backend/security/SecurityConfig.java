...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    CorsConfigurationSource corsConfigurationSource(){
        ...
        configuration.setAllowedOrigins(Arrays.asList("http://localhost:3000","http://localhost:80","http://localhost/api","http://localhost/","http://localhost:8888"));//з тих хостів ми дозволяємо звертатися до нашої програми
